    ...
    <>
        ...
        {data.cards.map(({ card, used }) => {
          ...
          return <div className="card overflow-hidden p-5" key={card.id} style={{ borderTop: `4px solid ${card.color}` }}>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <MutationForm action={toggleActiveAction} successMessage={card.isActive ? "Cartão desativado." : "Cartão reativado."}>
              ...
              <MutationForm action={deleteCardAction} successMessage="Cartão excluído.">
                <input type="hidden" name="id" value={card.id} />
                <ConfirmButton
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <FormDetails title="Cadastrar cartão">
          <MutationForm action={createCardAction} successMessage="Cartão cadastrado." className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Limite total"><input className="field" name="totalLimit" required placeholder="0,00" /></Field><Field label="Cor"><input className="field h-11" name="color" type="color" defaultValue="#111827" required /></Field>
        ...
        <FormDetails title="Registrar compra parcelada">
          <MutationForm action={createPurchaseAction} successMessage="Compra parcelada registrada." className="grid gap-4 sm:grid-cols-2">
